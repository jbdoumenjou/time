/**
* Class that manipulates period and manage string with ISO 8601 format
*/
...
TimePeriod.prototype.equals = function(other) {
  ...
  var datePartsAreEqual = this.years === other.years && this.months === other.months && this.days === other.days;
  var timePartsAreEqual = this.hours === other.hours && this.minutes === other.minutes && this.seconds === other.seconds;

  return  datePartsAreEqual && timePartsAreEqual;
};
